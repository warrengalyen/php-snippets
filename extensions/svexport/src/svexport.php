...
class SVExport
{
   ...
   */
    public function __construct($delimiter = ";", $empty_char = "-", $wrapper_char = "\"")
    {
   ...
   */
    public function fromArray($data_source)
    {
        $rows_str = "";
        $row_str = "";
   ...
   * @return array
   */
    public function fromFile($filepath, $load_keys = false)
    {
        $array = array();
   ...
   */
    public function save($filename, $forceUTF8 = false)
    {
        $buffer = $this->_buffer;
